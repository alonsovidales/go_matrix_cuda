...
const KER_MATRIX_SIGMOID_GRADIENT = `
//
...
.visible .entry matrixSigmoidGrad(
	.param .u64 matrixSigmoidGrad_param_0,
	.param .u32 matrixSigmoidGrad_param_1,
	.param .u32 matrixSigmoidGrad_param_2,
	.param .u32 matrixSigmoidGrad_param_3,
	.param .u32 matrixSigmoidGrad_param_4
)
{
	.reg .pred 	%p<19>;
	.reg .s32 	%r<27>;
	...
	ld.param.u64 	%rd2, [matrixSigmoidGrad_param_0];
	ld.param.u32 	%r4, [matrixSigmoidGrad_param_1];
	ld.param.u32 	%r5, [matrixSigmoidGrad_param_2];
	ld.param.u32 	%r6, [matrixSigmoidGrad_param_3];
	ld.param.u32 	%r7, [matrixSigmoidGrad_param_4];
	mov.u32 	%r8, %ctaid.x;
	mov.u32 	%r9, %tid.x;
...
BB0_11:
	{
	.reg .b32 %temp; 
	mov.b64 	{%temp, %r14}, %fd26;
	}
	xor.b32  	%r15, %r14, -2147483648;
	{
	.reg .b32 %temp; 
	mov.b64 	{%r16, %temp}, %fd26;
	}
...
BB0_13:
	...
	mov.b64 	%fd26, {%r24, %r26};
	bra.uni 	BB0_15;

BB0_14:
	add.rn.f64 	%fd26, %fd1, 0d4005BF0A8B145769;

BB0_15:
	add.rn.f64 	%fd21, %fd26, 0d3FF0000000000000;
	mov.f64 	%fd22, 0d3FF0000000000000;
	rcp.rn.f64 	%fd23, %fd21;
	sub.rn.f64 	%fd24, %fd22, %fd23;
	mul.rn.f64 	%fd25, %fd23, %fd24;
